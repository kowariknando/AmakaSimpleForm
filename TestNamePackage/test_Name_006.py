...
def setup():
    ...
    driver.find_element_by_xpath(data.nameXPATH).send_keys("Thisisanamewiththirtycharacters")
...
#Validate proper notification message is showed if Name is exactly 31 characters
